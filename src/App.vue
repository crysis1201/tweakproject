      ...
      <div v-show='toggle' class="bg-babyblue z-100 transition-opacity tablet:hidden border-textpink border-opacity-70 border-2 h-auto pt-4 pb-4  w-11/12 mx-auto rounded shadow-2xl absolute left-0 right-0 ">
        <div class="w-auto">
          ...
          <div class="drop-m transition-opacity "  v-bind:class="{show: dropDown}">
            <router-link to="/Social-Media-Marketing"><p @click="menuOpen = ! menuOpen, toggle = !toggle" class="text-center text-lg noselect text-brown cursor-default py-8 px-4   "><i>Social Media Marketing</i></p></router-link>
